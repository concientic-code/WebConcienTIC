# Spec — Rediseño web ConcienTIC (v3, diff completo v5 → v10)

> Reemplaza las versiones anteriores de este spec. `docs/concientic_v10_reference.html`
...
`docs/concientic_v10_reference.html`, implementado como Next.js mantenible,
