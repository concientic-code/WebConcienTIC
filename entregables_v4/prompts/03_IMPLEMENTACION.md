...
3. DQUILIBRIO (las 4 tarjetas son enlaces a subpáginas — ver
   `prompts/08_SUBPAGINAS_DQUILIBRIO.md`, no las implementes aquí como texto
   estático).
...
(`docs/concientic_v11_reference.html`) como base. No copies estilos
